...
cl.exe %compilerflags% %includedirs% ../../include/glad/glad.c ../../include/utils/glslprogram.cpp ../../include/utils/glutils.cpp RainSnow.cpp /Fe:RainSnow.exe /link %linkerflags% 
